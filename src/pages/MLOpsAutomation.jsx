...
const MLOpsAutomation = () => {
    return (
        <div className="case-study-page">
            <Helmet>
                <title>MLOps & Automation | sortNow & Company</title>
                <meta name="description" content="CI/CD for machine learning. Automated drift detection and model retraining pipelines." />
            </Helmet>
            <Navbar />
